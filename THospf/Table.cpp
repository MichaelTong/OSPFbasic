...
TblItem::TblItem(uns32 a, uns32 b) : _index1(a), _index2(b)
...
TblItem *Table::find(uns32 key1, uns32 key2)
...
TblItem *Table::previous(uns32 key1, uns32 key2)
...
void Table::remove(TblItem *item)

{
	...
	*item_parent = ptr;
    ...
    for (; (prev = (TblItem **) stack.pop()) != 0; parent_ptr = prev) {
	TblItem *parent;
	parent = *prev;
...
void left_shift(TblItem **balance_ptr)
...
void dbl_left_shift(TblItem **balance_ptr)
...
void right_shift(TblItem **balance_ptr)
...
void dbl_right_shift(TblItem **balance_ptr)
...
void TblSearch::seek(uns32 key1, uns32 key2)
